...
namespace UI
{
   public partial class frmCadAluno1 : frmModelo
   {
      public frmCadAluno1()
      {
         InitializeComponent();
      ...
      private void frmCadAluno1_Load(object sender, EventArgs e)
      {
         alteraBotoes(1);
      ...
      private void btnLocalizar_Click(object sender, EventArgs e)
      {
         ...
         if (form.codigo != 0)
         {
            ...
            cobCurso.Text = curso;
            cobTurma.Text = turma;
            txbCodAluno.Text = form.codigo.ToString();
      ...
      private void btnExcluir_Click(object sender, EventArgs e)
      {
         try
         {
            ...
            if (d.ToString() == "Yes")
            {
               var cmd = new OleDbCommand("DELETE FROM tblAlunos WHERE matricula = @matricula");
